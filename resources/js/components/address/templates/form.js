    ...
    <form address="form">
        <div class="box-body">
            <div class="form-group" v-bind:class="{ 'has-error': errors.name }">
                ...
                <input type="name" class="form-control" v-model.trim="item.name"  addressholder="name">
            ...
            <div v-if="item.id" class="form-group" v-bind:class="{ 'has-error': errors.slug }">
                ...
                <input type="slug" class="form-control" v-model.trim="item.slug"  addressholder="slug">
